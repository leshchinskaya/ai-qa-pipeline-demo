...
Object.assign(Devices, {
    ...
    async openBookingModal(deviceId) {
        ...
        const showUserSelect = isBookForOthersEnabled || Auth.isAdmin || Auth.isSharedAccount();
    ...
    async handleBooking() {
        ...
        const isBookForOthersEnabled = typeof FeatureFlags === 'undefined' || FeatureFlags.isEnabled('bookForOthers');
        const canBookForOthers = (Auth.isAdmin || Auth.isSharedAccount() || isBookForOthersEnabled) && !!selectedUserId;
        let usersCache = [];
